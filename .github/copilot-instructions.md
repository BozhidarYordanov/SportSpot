...
- **User Profile Page (/profile)**: This page will allow users to manage their account information and change their: name, email, phone and password. It will also include options for users to upload an avatar image.
